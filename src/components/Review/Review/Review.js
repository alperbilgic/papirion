...
const Review = (props) => {
    ...
    return (
        <div id={`review-${props.review.id}`} className='review-slide w-slide'>
            <Link to={link} style={{textDecoration: 'none', width: '100%', height: '100%'}} >
                ...
                <div className="review-heading">
                    ...
                    <div class="review-heading-username">
                    ...
                    <div className="review-text"><Link to="/reviews/" className="link-3" style={{textDecoration: 'none', color: 'black', height: '100%'}}>{script}</Link></div>
                </div>
            </Link>
        </div>
    )
